...
class NotificationController extends BaseController
{
    ...
    public function NotificationList()
    {
        ...
        $columns = 'NOTIFICATION_ID,NOTIF_TY_DESC,NOTIFICATION_DEPARTMENT,NOTIFICATION_TO_ID,NOTIFICATION_FROM_NAME,RSV_ID,NOTIFICATION_GUEST_ID,NOTIFICATION_URL,NOTIFICATION_TEXT,NOTIFICATION_DATE_TIME,NOTIFICATION_READ_STATUS,NOTIFICATION_FROM_ID,RSV_TRACE_RESOLVED_BY,UNSEEN_COUNT,SEEN_COUNT';
    ...
    public function notificationStatus()
    {
        ...
        $result = $this->NotificationRepository->notificationStatus($notification_id);
        return $this->respond(responseJson(200, false, ['msg' => 'status'], $result));
    }
}