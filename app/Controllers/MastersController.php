    ...
    public function updateRateCodeDetail()
    {
        try {
            ...
            $data = [
                ...
                "RT_CD_DT_1_ADULT" => setNullOnEmpty($this->request->getPost('RT_CD_DT_1_ADULT')),
                "RT_CD_DT_2_ADULT" => setNullOnEmpty($this->request->getPost('RT_CD_DT_2_ADULT')),
                "RT_CD_DT_3_ADULT" => setNullOnEmpty($this->request->getPost('RT_CD_DT_3_ADULT')),
                "RT_CD_DT_4_ADULT" => setNullOnEmpty($this->request->getPost('RT_CD_DT_4_ADULT')),
                "RT_CD_DT_5_ADULT" => setNullOnEmpty($this->request->getPost('RT_CD_DT_5_ADULT')),
                "RT_CD_DT_EXTRA_ADULT" => setNullOnEmpty($this->request->getPost('RT_CD_DT_EXTRA_ADULT')),
                "RT_CD_DT_EXTRA_CHILD" => setNullOnEmpty($this->request->getPost('RT_CD_DT_EXTRA_CHILD')),
                "RT_CD_DT_1_CHILD" => setNullOnEmpty($this->request->getPost('RT_CD_DT_1_CHILD')),
                "RT_CD_DT_2_CHILD" => setNullOnEmpty($this->request->getPost('RT_CD_DT_2_CHILD')),
                "RT_CD_DT_3_CHILD" => setNullOnEmpty($this->request->getPost('RT_CD_DT_3_CHILD')),
                "RT_CD_DT_4_CHILD" => setNullOnEmpty($this->request->getPost('RT_CD_DT_4_CHILD')),
                "RT_CD_DT_ROOM_TYPES" => "",
                "RT_CD_DT_PACKAGES" => "",
                "RT_CD_DT_DAYS" => "",                
            ];
