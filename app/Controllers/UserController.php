...
class UserController extends BaseController
{
    ...
    public function editUser()
    {
        ...
        $sql = "SELECT USR_NAME,USR_NUMBER,USR_FIRST_NAME,USR_LAST_NAME,USR_EMAIL,USR_PASSWORD,USR_ROLE_ID,USR_DEPARTMENT,FORMAT(USR_DOB, 'dd-MMM-yyyy') as USR_DOB,USR_ADDRESS,USR_CITY,USR_STATE,USR_COUNTRY,FORMAT(USR_DOJ, 'dd-MMM-yyyy') as USR_DOJ,USR_PHONE,USR_GENDER,USR_TEL_EXT,USR_STATUS,ROLE_NAME,SUPER_ID,SUPER_DEPT FROM FLXY_USERS LEFT JOIN FLXY_USER_ROLE ON USR_ROLE_ID = ROLE_ID LEFT JOIN COUNTRY ON FLXY_USERS.USR_COUNTRY = COUNTRY.id LEFT JOIN FLXY_DEPARTMENT ON USR_DEPARTMENT = DEPT_ID LEFT JOIN STATE ON FLXY_USERS.USR_STATE = STATE.id LEFT JOIN FLXY_USER_SUPER UP ON UP.USER_ID = USER_ID WHERE USR_ID=:SYSID:";
