...
class TaskAssignmentController extends BaseController
{
    ...
    public function viewTaskAssignedRooms(){
        ...
        $columns = "HKARM_ID,HKARM_TASK_ID,HKARM_TASK_SHEET_ID,HKARM_ROOM_ID,HKATD_ASSIGNED_TASK_ID,HKARM_CREDITS,HKARM_INSTRUCTIONS,RM_NO,RM_DESC,HKATD_START_TIME,HKATD_COMPLETION_TIME,INSPECTED_NAME,HKATD_INSPECTED_DATETIME,TOTAL_TIME,COMPLETED,TOT";
        $mine->generate_DatatTable($tableName, $columns, $init_cond);
        exit;
    }
