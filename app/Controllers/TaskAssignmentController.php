...
class TaskAssignmentController extends BaseController
{
    ...
    public function viewTaskAssignedRooms(){
        ...
        $columns = "HKARM_ID,HKARM_TASK_ID,HKARM_TASK_SHEET_ID,HKARM_ROOM_ID,HKATD_ASSIGNED_TASK_ID,HKARM_CREDITS,HKARM_INSTRUCTIONS,RM_NO,RM_DESC,START_TIME,COMPLETE_TIME,INSPECTED_NAME,INSPECTEDTIME,INSPECTED,COMPLETED,TOTAL_TIME,TOT";
        $mine->generate_DatatTable($tableName, $columns, $init_cond);
        exit;
    }
