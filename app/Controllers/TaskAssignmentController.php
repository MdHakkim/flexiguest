...
class TaskAssignmentController extends BaseController
{
    ...
    public function viewTaskAssignedRooms(){
        $UserID = session()->get('USR_ID');
        $mine   = new  TaskAssignmentDataTable();
        $tableName = "(SELECT HKARM_ID,HKARM_TASK_ID,HKARM_TASK_SHEET_ID,HKARM_ROOM_ID,HKATD_ASSIGNED_TASK_ID,HKARM_CREDITS,HKARM_INSTRUCTIONS,RM_NO,RM_DESC,MAX(HKATD_COMPLETION_TIME) as HKATD_COMPLETION_TIME,
        ...
        HKARM_INSTRUCTIONS,RM_NO,RM_DESC,HKATD_INSPECTED_DATETIME,CONCAT_WS(' ', USR_FIRST_NAME,USR_LAST_NAME),TIME_TAKEN.TOTAL_TIME,COMPLETE.COMPLETED,COMPLETE.TOT) AS OUTPUT";
        $init_cond = [];
        ...
        $columns = "HKARM_ID,HKARM_TASK_ID,HKARM_TASK_SHEET_ID,HKARM_ROOM_ID,HKATD_ASSIGNED_TASK_ID,HKARM_CREDITS,HKARM_INSTRUCTIONS,RM_NO,RM_DESC,HKATD_COMPLETION_TIME,INSPECTED_NAME,HKATD_INSPECTED_DATETIME,TOTAL_TIME,COMPLETED,TOT";
        $mine->generate_DatatTable($tableName, $columns, $init_cond);
        exit;
    }
