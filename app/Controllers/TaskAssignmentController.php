...
class TaskAssignmentController extends BaseController
{
    ...
    public function viewTaskAssignedRooms(){
        ...
        $tableName = "SELECT HKARM_ID,HKARM_TASK_ID,HKARM_TASK_SHEET_ID,HKARM_ROOM_ID,HKATD_ASSIGNED_TASK_ID,HKARM_CREDITS,HKARM_INSTRUCTIONS,RM_NO,RM_DESC,START_TIME,COMPLETE_TIME,INSPECTED_NAME,INSPECTEDTIME,INSPECTED,COMPLETED,TOT FROM FLXY_HK_TASK_ASSIGNED_ROOMS        
                INNER JOIN FLXY_ROOM ON RM_ID = HKARM_ROOM_ID          
                LEFT JOIN FLXY_HK_TASKASSIGNMENT_OVERVIEW ON  HKTAO_ID = HKARM_TASK_ID        
                LEFT JOIN FLXY_HK_ASSIGNED_TASK_DETAILS ON HKARM_ROOM_ID = HKATD_ROOM_ID         
                ...
                TIME_TAKEN.TOTAL_TIME,COMPLETE.COMPLETED,COMPLETE.TOT,INSPECTED";
        $init_cond = [];
        ...
        $columns = "HKARM_ID,HKARM_TASK_ID,HKARM_TASK_SHEET_ID,HKARM_ROOM_ID,HKATD_ASSIGNED_TASK_ID,HKARM_CREDITS,HKARM_INSTRUCTIONS,RM_NO,RM_DESC,START_TIME,COMPLETE_TIME,INSPECTED_NAME,INSPECTEDTIME,INSPECTED,COMPLETED,TOTAL_TIME";
        $mine->generate_DatatTable($tableName, $columns, $init_cond);
        exit;
    }
