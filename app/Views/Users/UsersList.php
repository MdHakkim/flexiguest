                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <input type="text" id="USR_DOB" name="USR_DOB" class="form-control"
                                                        placeholder="DD-MM-YYYY">
                                                    <span class="input-group-append">
                                                        <span class="input-group-text bg-light d-block">
                                                            <i class="fa fa-calendar"></i>
                            ...
                            <div class="text-left">
                                <div class="col-md-12">
                                    <label class="switch switch-lg">
                                        <input id="USR_STATUS" name="USR_STATUS" type="checkbox" value="1"
                                            class="switch-input" />
        ...
        var dt_user = dt_user_table.DataTable({
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        var $name = (full['USR_FIRST_NAME'] ?? '') + ' ' + (full[
                                'USR_LAST_NAME'] ?? ''),
                        ...
                        var $row_output =
                            ...
                            '<a href="javascript:;" class="text-body text-truncate editWindow" data_sysid="' +
                            full['USR_ID'] +
    ...
    $.ajax({
        ...
        success: function(respn) {
            ...
            if (response != '1') {
                ...
                var alertText = $('#USR_ID').val() == '' ? '<li>New user has been added </li>' :
                    '<li>The user has been updated</li>';
