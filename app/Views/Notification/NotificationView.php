                      ...
                      <div class="col-md-12">
                        ...
                        <div class="row mb-3">                         
                          ...
                          <label class="switch">
                                    ...
                                    <input id="NOTIFICATION_SEND_NOW"  value="1" name="NOTIFICATION_SEND_NOW" type="checkbox"
                                        class="switch-input" />
...
function notificationTypeList() {
  ...
  $("#submitForm [name='NOTIFICATION_DEPARTMENT[]']").change(function() {
