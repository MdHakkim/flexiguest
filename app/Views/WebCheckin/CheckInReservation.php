                ...
                <div class="col-11 flxy_web_content">
                    <div class="flxy_wrapper">
                                ...
                                <div class="flxy_block_card">
                                    ...
                                    <div class="card">
                                        <div class="flxy_card_head">
                                            Document Images <span class="deleteUploadImage"><i
                                                ...
                                                <div class="tab-pane fade show active p-3" id="profile">
                                                    <form id="documentDetailForm">
                                                        ...
                                                        <div class="row ">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text"
                                                                    value="<?php echo $data['CUST_NATIONALITY']; ?>"
                                                                    class="form-control form-control-sm"
                                                                    id="CUST_NATIONALITY" name="CUST_NATIONALITY"
                        ...
                        <div class="flxy_signature_block">
                            ...
                            <div class="row" style="justify-content: right;padding: 48px;">
                                <div class="col-md-3">
                                    <button type="button"
                                        <?php echo $data['RESV_SINGATURE_URL'] != '' ? 'style="display:none;"' : ''; ?>
                                        id="clickSignature" class="btn btn-secondary">Click to sign here</button>

                                    <img id="captureSignature"
                                        class="<?= $data['RESV_SINGATURE_URL'] ? '' : 'd-none' ?>" style="width:100%;"
                                        src="<?= $data['RESV_SINGATURE_URL'] ? base_url('assets/Uploads/UserDocuments/signature/' . $data['RESV_SINGATURE_URL']) : '' ?>" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flxy_web-footer text-end">
                        ...
                        <?php
                            if ($data['RESV_STATUS'] == 'Due Pre Check-In') {
                            ?>
                        <button type="button" onClick="updateSignature()"
...
<!-- Vaccine Details -->
<div class="modal fade" id="vaccineModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body flxy_padding">
                <form id="vaccineForm">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-sm-8">
                            <input type="text" readonly value="<?php echo $data['RESV_ID']; ?>"
                                class="form-control form-control-sm" name="VACC_RESV_ID" placeholder="Phone">
                        </div>
                    </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-sm-8">
                            <input type="text" readonly value="<?php echo $data['FULLNAME']; ?>"
                                class="form-control form-control-sm" name="FULLNAME" placeholder="Phone">
                        </div>
                    </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-sm-8">
                            <input class="form-check-input" type="hidden" value="FULLY" name="VACC_DETAILS"
                                id="VACC_DETAILS">

                            <div class="form-check">
                                <input class="form-check-input radioCheck" checked type="radio" id="VACC_DETL_1"
                                    name="VACC_DETL" method="FULLY">
                            ...
                            <div class="form-check">
                                <input class="form-check-input radioCheck" type="radio" id="VACC_DETL_2"
                                    name="VACC_DETL" method="EXMP">
                            ...
                            <div class="form-check">
                                <input class="form-check-input radioCheck" type="radio" id="VACC_DETL_3"
                                    name="VACC_DETL" method="PROCE">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-sm-8">
                            <div class="input-group mb-2">
                                <input type="text" id="VACC_LAST_DT" name="VACC_LAST_DT"
                                    class="form-control VACC_LAST_DT form-control-sm" placeholder="DD-MM-YYYY">
                                <span class="input-group-append">
                                    <span class="input-group-text bg-light d-block">
                                        <i class="fa fa-calendar"></i>
                                    </span>
                    ...
                    <div class="row ">
                        <input type="hidden" class="form-control form-control-sm" id="VACC_DOC_SAVED"
                            name="VACC_DOC_SAVED">
                        <label class="col-sm-4 col-form-label text-end">Vaccine Certificate</label>
                        <div class="col-sm-8">
                            <input class="form-control form-control-sm" id="fileUpload" name="files[]" multiple
                                onChange="uploadVaccine(this)" type="file">
                        </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-sm-8">
                            <select name="VACC_ISSUED_COUNTRY" id="VACC_ISSUED_COUNTRY" data-width="100%"
                                class="selectpicker VACC_ISSUED_COUNTRY" data-live-search="true">
                                <option value="">Select</option>
                            </select>
                        </div>
                    </div>
            ...
            <div class="modal-footer flxy_modClass">
                <button type="button" id="updateVaccine" class="btn btn-primary btn-sm"><i
                        class="fa-solid fa-check"></i> Update</button>
            </div>
        </div>
    </div>
</div>
...
<!-- Upload Signature -->
<div class="modal fade" id="signaturWindow" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="checkInConfirmWindow" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="d-grid gap-2">
                        <button class="btn btn-primary" onClick="confirmPrecheckin()" type="button">Pre-Check-in
                            Now</button>
                    </div>
                </div>
            </div>
                ...
                if (respn.vacc_details.length) {
                    ...
                    if (filePath != '') {
                        ...
                        $.each(arrayPath, function(i) {
                            $('.previewClass').append('<span id="vaccinePreview"><span id="' +
                                arrayPath[i] +
                                '" class="vaccdelete"><i class="fa-solid fa-xmark"></i></span><img src="<?php echo $folderPath; ?>' +
                                '/UserDocuments/vaccination/' + arrayPath[i] + '" id=""></span>'
                            );
                        });
                    }
...
function generaListImage(listImage) {
    ...
    $.each(listImage, function(inx, data) {
        if ($.isNumeric(inx)) {
            ...
            liList += '<li data-file_name="' + data['DOC_FILE_PATH'] + '" data_id="' + data['DOC_ID'] +
                '" class="' + activeClass +
                '"><img id="imagesmall" class="card-img-top" src="<?php echo $folderPath; ?>' +
                '/UserDocuments/proof/' + data['DOC_FILE_PATH'] + '"></li>';
        }
    });
