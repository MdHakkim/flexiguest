                    ...
                    <div class="card">
                      ...
                      <ul class="list-group list-group-flush flxy_web-ul">
                        ...
                        <li class="list-group-item text-flxy">
                          ...
                          <div class="flxy-data">: <span class="flxy_doc_prof flxy_doc_st <?php echo $statusClass; ?>">Pending</span></div>
                        </li>
                        <li class="list-group-item text-flxy">
                          <div class="flxy-data">Vaccine Certificate</div>
                          <div class="flxy-data">: <span class="flxy_doc_vacc flxy_doc_st <?php echo $statusClass; ?>">Pending</span></div>
                        </li>
