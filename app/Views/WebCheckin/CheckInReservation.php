                                                        ...
                                                        <div class="row ">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <div class="form-check mb-2"
                                                                    ...
                                                                    <input type="radio" id="CUST_GENDER_Male"
                                                                        name="CUST_GENDER" value="Male"
                                                                        class="form-check-input" required="" <?php echo $data['CUST_GENDER'] == 'Male' ? 'checked' : ''; ?>>
                                                                    <label class="form-check-label"
                                                                        for="CUST_GENDER_Male">Male</label>
                                                                </div>
                                                                <div class="form-check" style="float:left">
                                                                    <input type="radio" id="CUST_GENDER_Female"
                                                                        name="CUST_GENDER" value="Female"
                                                                        class="form-check-input" required="" <?php echo $data['CUST_GENDER'] == 'Female' ? 'checked' : ''; ?>>
                                                                    <label class="form-check-label"
                                                                        for="CUST_GENDER_Female">Female</label>
                                                                </div>
            ...
            <div class="modal-body flxy_padding">
                <form id="vaccineForm">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-sm-8">
                            <input class="form-check-input" type="hidden" value="vaccinated" name="VACC_DETAILS"
                                id="VACC_DETAILS">

                            <div class="form-check">
                                <input class="form-check-input radioCheck" checked type="radio" id="VACC_DETL_1"
                                    name="VACC_DETL" method="vaccinated">
                            ...
                            <div class="form-check">
                                <input class="form-check-input radioCheck" type="radio" id="VACC_DETL_2"
                                    name="VACC_DETL" method="medicallyExempt">
                            ...
                            <div class="form-check">
                                <input class="form-check-input radioCheck" type="radio" id="VACC_DETL_3"
                                    name="VACC_DETL" method="vaccinationLater">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-8">
                            ...
                            <select name="VACC_TYPE" id="VACC_TYPE" data-width="100%" class="selectpicker VACC_TYPE"
