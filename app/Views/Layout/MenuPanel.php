...
<nav class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme" id="layout-navbar">
    <div class="container-fluid">
                            ...
                            <div class="row row-bordered overflow-visible g-0">
                                <div class="dropdown-shortcuts-item col">
                                    ...
                                    <a href="<?php echo base_url('/reservation') ?>"
                                        class="stretched-link">Reservations</a>
                                ...
                                <div class="dropdown-shortcuts-item col">
                                    ...
                                    <a href="<?php echo base_url('/my-profile/edit') ?>"
                                        class="stretched-link">Settings</a>
                ...
                <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-2">
                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown"
                        ...
                        <span class="badge rounded-pill badge-notifications bg-danger">
                            <?= view_cell('\App\Libraries\Notification::NotificationCount') ?></span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end py-0">
                        <li class="dropdown-menu-header border-bottom">
                            <div class="dropdown-header d-flex align-items-center py-3">
                                <h5 class="text-body me-auto mb-0">Notifications</h5>
                                <a href="javascript:void(0)" class="dropdown-notifications-all text-body read-all"
                            ...
                            <a class="dropdown-item" href="<?php echo base_url('/my-profile') ?>">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <span
                                            class="lh-1 d-block fw-semibold"><?php echo session()->get('USR_FIRST_NAME').' '.session()->get('USR_LAST_NAME'); ?></span>
        ...
        <div class="navbar-search-wrapper search-input-wrapper d-none">
            <input type="text" class="form-control search-input main-menu-search container-fluid border-0"
                placeholder="Enter 3 or more characters..." aria-label="Enter 3 or more characters..." />
                            ...
                            <div class="col-md-12">
                                <div class="border rounded p-4 mb-3">
                                    <div class="table-responsive text-nowrap">
                                        <table id="dataTable_view1"
                                            class="dt-responsive table table-striped display nowrap" style="width:100%">
                                            <thead>
                                                <tr>
                    ...
                    render: function(data, type, row, meta) {
                        if (data['NOTIF_TRAIL_ID'] != '') {
                            return (
                                ...
                                '<a  href="javascript:;" data_sysid="' + data[
                                    'NOTIF_TRAIL_ID'] +
                                '" class="dropdown-item text-primary" onClick="viewAllNotif(' +
                                data['NOTIF_TRAIL_ID'] +
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        if (full['NOTIFICATION_RESERVATION_ID'] != '') {
                            return getResvNo(full['NOTIFICATION_RESERVATION_ID'], full[
                                'NOTIF_TY_ID'], full['NOTIF_TRAIL_ID'], full[
                                'NOTIFICATION_ID'], full['NOTIF_TRAIL_READ_STATUS']);
                        } else
                            return '';
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        return '<span class="notifi-status-' + full['NOTIF_TRAIL_ID'] +
                            ' badge ' + statusObj[$status].class + '" id="not_status">' +
...
function getResvNo(NOTIFICATION_RESERVATION_ID, NOTIF_TY_ID, NOTIF_TRAIL_ID, NOTIFICATION_ID,
NOTIFICATION_READ_STATUS) {
    ...
    if (resvNo != null) {
        ...
        if (NOTIF_TY_ID == 4 && NOTIFICATION_READ_STATUS == 0) {
            result +=
                '<br><button type="button" class="btn btn-sm btn-primary" title="Resolve" id="resolveButton"  data-trail_id ="' +
                NOTIF_TRAIL_ID + '" data-notification_id = "' + NOTIFICATION_ID + '" >Resolve</button>';
                ...
                $.ajax({
                    ...
                    success: function(respn) {
                        if (respn != null && respn.status === "success") {
                            ...
                            $("#dataTable_view1 .notifi-" + trail_id).removeClass(
                                'table-warning');
                            $(".badge-notifications").html(respn.responseStatusCount);
