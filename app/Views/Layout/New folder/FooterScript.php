    ...
    <script src="<?php //echo base_url('assets/vendor/libs/flatpickr/flatpickr.js')?>"></script>
    <!-- Row Group JS -->
    <script src="<?php //echo base_url('assets/vendor/libs/datatables-rowgroup/datatables.rowgroup.js')?>"></script>
    <script src="<?php //echo base_url('assets/vendor/libs/datatables-rowgroup-bs5/rowgroup.bootstrap5.js')?>"></script>
    <!-- Form Validation -->
