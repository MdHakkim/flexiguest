    ...
    <div class="container">
        <div class="table-1">
            <table>
                ...
                <?php
                if ($data['CR_PAYMENT_METHOD'] == 'Credit/Debit card' && !empty($data['transaction_id'])) {
                ?>
                    <tr>
                        <td>Payment Method</td>
                        <td>:</td>
                        <td><?= $data['CR_PAYMENT_METHOD'] ?></td>
        ...
        <div class="table-2">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>1</td>
                        <td><?= date_create($data['CR_CREATED_AT'])->format('Y-m-d') ?></td>
                        <td><?= $data['CO_TITLE'] ?></td>
                        <td><?= $data['CO_NET_PRICE'] ?></td>
                        <td><?= $data['CR_QUANTITY'] ?></td>
                        <td><?= $data['CO_NET_PRICE'] * $data['CR_QUANTITY'] ?></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="border-top-bottom"><b><?= $data['CR_TOTAL_AMOUNT'] ?></b></td>
                    </tr>
