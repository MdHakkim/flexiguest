...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="breadcrumb-wrapper py-3 mb-4"><span class="text-muted fw-light">Masters /</span> Market
            Groups</h4>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="popModalWindowlabel">Market Group</h4>
                ...
                <div class="modal-body">
                    <form id="submitForm" class="needs-validation" novalidate>
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label class="switch">
                                    <input id="MK_GR_STATUS" name="MK_GR_STATUS" type="checkbox" value="1"
                                        class="switch-input" />
...
$(document).ready(function() {
    ...
    $('#dataTable_view').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url': '<?php echo base_url('/marketGroupView')?>'
        },
        'columns': [{
                data: ''
            },
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    return (
                        ...
                        '<li><a href="javascript:;" data_sysid="' + data['MK_GR_ID'] +
        ...
        }, 
        {
          ...
          width: "15%",
          render: function (data, type, full, meta) {
            var $status_number = full['MK_GR_STATUS'];
            var $status = {
        ...
        responsive: {
            details: {
                display: $.fn.dataTable.Responsive.display.modal({
                    header: function(row) {
                        var data = row.data();
                        return 'Details of ' + data['MK_GR_CODE'];
                    }
                }),
                type: 'column',
...
function addForm() {
    ...
    $('#popModalWindowlabel').html('Add New Market Group');
    $("#MK_GR_CODE").prop("readonly", false);
...
$(document).on('click', '.delete-record', function() {
    ...
    bootbox.confirm({
        ...
        callback: function(result) {
            if (result) {
                $.ajax({
                    url: '<?php echo base_url('/deleteMarketGroup')?>',
                    type: "post",
                    data: {
                        sysid: sysid
                    },
                    ...
                    success: function(respn) {
                        showModalAlert('warning',
                            '<li>The Market Group has been deleted</li>');
...
$(document).on('click', '.editWindow', function() {
    ...
    var sysid = $(this).attr('data_sysid');
    $('#popModalWindowlabel').html('Edit Market Group');
    $("#MK_GR_CODE").prop("readonly", true);

    $('#popModalWindow').modal('show');

    var url = '<?php echo base_url('/editMarketGroup')?>';
    $.ajax({
        url: url,
        type: "post",
        headers: {
...
// Add New or Edit Market Group submit Function

function submitForm(id) {
    hideModalAlerts();
    var formSerialization = $('#' + id).serializeArray();
    var url = '<?php echo base_url('/insertMarketGroup')?>';
    $.ajax({
        url: url,
        type: "post",
        ...
        success: function(respn) {
            ...
            if (response != '1') {
                ...
                var alertText = $('#MK_GR_ID').val() == '' ? '<li>The new Market Group \'' + $(
                        '#MK_GR_CODE')
                    .val() + '\' has been created</li>' : '<li>The Market Group \'' + $(
                        '#MK_GR_CODE').val() +
                    '\' has been updated</li>';
