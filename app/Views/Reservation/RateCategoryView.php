...
<?= $this->include('Layout/SuccessReport') ?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="breadcrumb-wrapper py-3 mb-4"><span class="text-muted fw-light">Rate Management / Rate Classifications /</span> Rate Categories</h4>
                            ...
                            <form id="submitForm" class="needs-validation" novalidate>
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <input type="text" name="RT_CT_CODE" id="RT_CT_CODE" class="form-control bootstrap-maxlength" maxlength="10" placeholder="eg: OTA" required />
                                    </div>
                                    <div class="col-md-5">
                                        <lable class="form-lable"><b>Select Rate Class *</b></lable>
                                        <select id="RT_CL_ID" name="RT_CL_ID" class="select2 form-select form-select-lg" data-allow-clear="true" required>
                                          <?=$rateClassOptions?>
                                        </select>
                                    </div>
                                    <div class="col-md-8">
                                        <lable class="form-lable"><b>Rate Category Description *</b></lable>
                                        <input type="text" name="RT_CT_DESC" id="RT_CT_DESC" class="form-control bootstrap-maxlength" maxlength="50" placeholder="eg: Online Travel Agent" required />
                                    </div>
                                    <div class="col-md-4">
                                        <lable class="form-lable">Display Sequence</lable>
                                        <input type="number" name="RT_CT_DIS_SEQ" id="RT_CT_DIS_SEQ" class="form-control" min="0" placeholder="eg: 3" />
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label"><b>Begin Date *</b></label>
                                        <div class="input-group mb-6">
                                          <input type="text" id="RT_CT_BEGIN_DT" name="RT_CT_BEGIN_DT" class="form-control RT_CT_BEGIN_DT" placeholder="d-Mon-yyyy" required />
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group mb-6">
                                          <input type="text" id="RT_CT_END_DT" name="RT_CT_END_DT" class="form-control RT_CT_END_DT" placeholder="d-Mon-yyyy" />
                                          <span class="input-group-append">
                                              <span class="input-group-text bg-light d-block">
                                                  <i class="fa fa-calendar"></i>
                                              </span>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                  ...
                                  <div data-repeater-item>
                                    <div class="row">
                                      <div class="col-12 col-md-8 mb-0 mb-3">
                                        <label class="form-label" for="form-repeater-1-1"><b>Rate Category Code *</b></label>
                                        <input type="text" name="RT_CT_CODE" id="form-repeater-1-1" class="form-control" maxlength="10" placeholder="eg: OTA" required />
                                      </div>
                            ...
                            <div class="form-text" style="clear: both; padding-top: 20px;">Rate Category Description & Dates will be copied from original </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#dataTable_view').DataTable({
            ...
            return (
              '<div class="d-inline-block">' +
                ...
                '<ul class="dropdown-menu dropdown-menu-end">' +
                  '<li><a href="javascript:;" data_sysid="'+data['RT_CT_ID']+'" class="dropdown-item editWindow text-primary"><i class="fa-solid fa-pen-to-square"></i> Edit</a></li>' +
                  '<div class="dropdown-divider"></div>' +
                  '<li><a href="javascript:;" data_sysid="'+data['RT_CT_ID']+'" data_rtcode="'+data['RT_CT_CODE']+'" class="dropdown-item copyWindow text-success"><i class="fa-solid fa-copy"></i> Copy</a></li>' +
                  '<div class="dropdown-divider"></div>' +
                  '<li><a href="javascript:;" data_sysid="'+data['RT_CT_ID']+'" class="dropdown-item text-danger delete-record"><i class="fa-solid fa-ban"></i> Delete</a></li>' +
                '</ul>' +
              '</div>'
            );
          }},
      ...
      columnDefs: [
        ...
        },{width: "15%"},{width: "18%"},{width: "9%"},{width: "9%"},{width: "9%"},{width: "9%"},{width: "12%"},{width: "12%"}
      ],
        "order": [[ 3, "asc" ]],
        destroy: true,
            ...
            if(result){
              $.ajax({
                ...
                success:function(respn){
                  showModalAlert('warning', '<li>The Rate Category has been deleted</li>'); 
  ...
  $(document).on('click','.copyWindow',function(){
    ...
    $('#copyModalWindowlabel').html('Create Rate Category Copies for \'' + rtcode + '\'');
  ...
  $.ajax({
      ...
      success:function(respn){
        ...
        if(response!='1'){
          ...
          var alertText = $('#RT_CT_ID').val() == '' ? '<li>The new Rate Category \'' + $('#RT_CT_CODE').val() + '\' has been created</li>' : '<li>The Rate Category \'' + $('#RT_CT_CODE').val() + '\' has been updated</li>';
  ...
  $.ajax({
      ...
      success:function(response){
        if(response == '0'){
          ...
          showModalAlert('success', '<li>' + response + ' new Rate Category copies have been created</li>'); 
