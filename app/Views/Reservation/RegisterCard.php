	...
	v14.8C5,178.5,15.2,164.2,28,154.9z"></path>
      ...
      <div class="table-responsive">
        <table class="table  m-0" width="100%">
          ...
          <tbody>
            <tr>
              <td width="5%"><?= $guestDetails['RESV_ROOM']?></td>
              <td width="5%"><?= $guestDetails['RESV_ARRIVAL_DT']?></td>
              <td width="5%"><?= $guestDetails['RESV_DEPARTURE']?></td>
              <td width="5%"><?= $guestDetails['RESV_NIGHT']?></td>
              <td width="5%"><?= $guestDetails['RESV_ADULTS'].'/'.$guestDetails['RESV_ADULTS']?></td>
      ...
      <div class="row p-3">
        <div class="col-12">
          <span>
            <b>Guest Signature: </b>
            <?php
              if($guestDetails['GUEST_SIGNATURE']) {
            ?>
              <img src="<?= base_url('assets/Uploads/UserDocuments/signature/'.$guestDetails['GUEST_SIGNATURE']) ?>" width="auto" height="100"/>
            <?php
            }
            ?>
          </span>
