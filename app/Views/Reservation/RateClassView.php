...
<div class="content-wrapper">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-6">
                                    <input type="text" id="RT_CL_BEGIN_DT" name="RT_CL_BEGIN_DT"
                                        class="form-control RT_CL_BEGIN_DT" placeholder="d-Mon-yyyy" required />
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group mb-6">
                                    <input type="text" id="RT_CL_END_DT" name="RT_CL_END_DT"
                                        class="form-control RT_CL_END_DT" placeholder="d-Mon-yyyy" />
                                    <span class="input-group-append">
                                        <span class="input-group-text bg-light d-block">
                                            <i class="fa fa-calendar"></i>
                                        </span>
    ...
    <div class="modal fade" id="copyModalWindow" data-backdrop="static" data-keyboard="false"
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="copyModalWindowlabel">Create Rate Class Copies</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-lable="Close"></button>
                </div>
                <div class="modal-body">
                            ...
                            <div data-repeater-item>
                                <div class="row">
                                    <div class="col-12 col-md-8 mb-0 mb-3">
                                        <label class="form-label" for="form-repeater-1-1"><b>Rate Class Code
                                                *</b></label>
                                        <input type="text" name="RT_CL_CODE" id="form-repeater-1-1" class="form-control"
                    ...
                    <div class="form-text" style="clear: both; padding-top: 20px;">Rate Class Description & Dates will
                ...
                $.ajax({
                    ...
                    success: function(respn) {
                        showModalAlert('warning',
                            '<li>The Rate Class has been deleted</li>');
...
$(document).on('click', '.editWindow', function() {
    ...
    var sysid = $(this).attr('data_sysid');
    $('#popModalWindowlabel').html('Edit Rate Class');
    ...
    $.ajax({
        ...
        success: function(respn) {
            ...
            if (response != '1') {
                ...
                var alertText = $('#RT_CL_ID').val() == '' ? '<li>The new Rate Class \'' + $('#RT_CL_CODE')
                    .val() + '\' has been created</li>' : '<li>The Rate Class \'' + $('#RT_CL_CODE').val() +
                    '\' has been updated</li>';
