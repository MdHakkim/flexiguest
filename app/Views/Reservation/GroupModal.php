    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
                ...
                <form id="GroupForm">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="GRP_ADDRESS1" id="GRP_ADDRESS1" class="form-control"
                                placeholder="addresss 1" />
                        </div>
                        <div class="col-md-3 flx_top_lb">
                            <label class="form-label"></label>
                            <input type="text" name="GRP_ADDRESS2" id="GRP_ADDRESS2" class="form-control"
                                placeholder="address 2" />
                        </div>
                        <div class="col-md-3 flx_top_lb">
                            <label class="form-label"></label>
                            <input type="text" name="GRP_ADDRESS3" id="GRP_ADDRESS3" class="form-control"
                                placeholder="address 3" />
                        </div>
                        <div class="col-md-3">
                            <label class="form-label col-md-12">Country</label>
                            <select name="GRP_COUNTRY" id="GRP_COUNTRY" data-width="100%"
                                class="selectpicker GRP_COUNTRY" data-live-search="true">
                                <option value="">Select</option>
                            </select>
                        </div>
                        <div class="col-md-3">
                            <label class="form-label col-md-12">State</label>
                            <select name="GRP_STATE" id="GRP_STATE" data-width="100%" class="selectpicker GRP_STATE"
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="GRP_CITY" id="GRP_CITY" data-width="100%" class="selectpicker GRP_CITY"
                                data-live-search="true">
                                <option value="">Select</option>
                            </select>
                        </div>
                        <div class="col-md-3">
                            ...
                            <input type="text" name="GRP_POSTAL" id="GRP_POSTAL" class="form-control"
                                placeholder="postal" />
                        </div>

                        <div class="col-md-3">
                            <label class="form-label">Contact No</label>
                            <input type="text" name="GRP_CONTACT_NO" id="GRP_CONTACT_NO" class="form-control"
                                placeholder="client id" />
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">Contact Email</label>
                            <input type="text" name="GRP_EMAIL" id="GRP_EMAIL" class="form-control"
                                placeholder="client id" />
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="GRP_COMMUNI_CODE" id="GRP_COMMUNI_CODE" class="select2 form-select"
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" name="GRP_NOTES" id="GRP_NOTES" class="form-control"
                                placeholder="communication desc" />
                        </div>
                        <div class="col-md-3">
            ...
            <div class="modal-footer">
                ...
                <button type="button" onClick="submitFormGrp('GroupForm')" id="submitBtn"
...
function editGroup(sysid) {
    runCountryListExdClass();
    runSupportingLov();

    $('#GroupWindow').modal('show');
    $('#GroupWindowLable').html('Edit Group');
        ...
        success: function(respn) {
            ...
            $(respn).each(function(inx, data) {
                $.each(data, function(fields, datavals) {
                    ...
                    if (field == 'GRP_COUNTRY_DESC' || field == 'GRP_STATE_DESC' || field ==
                        'GRP_CITY_DESC') {
                        return true;
                    };
