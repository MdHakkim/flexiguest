            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="submitForm" class="needs-validation" novalidate>
                        <div class="row g-3">
                            <input type="hidden" name="PKG_CD_ID" id="PKG_CD_ID" class="form-control" />
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-5">
                                            <select id="TC_SGR_ID" name="TC_SGR_ID"
                                                ...
                                                required>
                                                <?=$packageCodeSubGroupOptions?>
                                            </select>
                                        </div>
                                    </div>

                                    <div class="row mb-3">
                                        <label for="html5-text-input" class="col-form-label col-md-3">Select Package
                                            Type</label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="row mb-3">
                                        <label for="html5-text-input" class="col-form-label col-md-3">Adjustment
                                            Code</label>
                                        <div class="col-md-5">
                                            <select id="PKG_CD_ADJ" name="PKG_CD_ADJ"
                                                class="select2 form-select form-select-lg" data-allow-clear="true">
                                                <?=$adjPackageCodeOptions?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <label for="html5-text-input" class="col-form-label col-md-3">Default
                                            Price</label>
                                        <div class="col-md-3">
                                            <input type="number" name="PKG_CD_DEF_PRICE" id="PKG_CD_DEF_PRICE"
                                    ...
                                    <div class="row mb-3">
                                        <label for="html5-text-input" class="col-form-label col-md-3">Minimum
                                            Amount</label>
                                        <div class="col-md-3">
                                            <input type="number" name="PKG_CD_MIN_AMT" id="PKG_CD_MIN_AMT"
                                                class="form-control" min="0" placeholder="" />
                                        </div>
                                        ...
                                        <label for="html5-text-input" class="col-form-label col-md-3">Maximum
                                            Amount</label>
                                        <div class="col-md-3">
                                            <input type="number" name="PKG_CD_MAX_AMT" id="PKG_CD_MAX_AMT"
                                                class="form-control" min="0" placeholder="" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="border rounded p-3">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <label class="switch">
                                            <input id="PKG_CD_REVN_GRP" name="PKG_CD_REVN_GRP" type="checkbox" value="1"
                                                class="switch-input" />
                                    ...
                                    <div class="col-md-4">
                                        <label class="switch">
                                            <input id="PKG_CD_MEMBERSHIP" name="PKG_CD_MEMBERSHIP" type="checkbox"
                                    ...
                                    <div class="col-md-4">
                                        <label class="switch">
                                            <input id="PKG_CD_MANUAL_POST" name="PKG_CD_MANUAL_POST" type="checkbox"
                                                value="1" class="switch-input" />
                                            <span class="switch-toggle-slider">
                                                <span class="switch-on">
                                                    <i class="bx bx-check"></i>
                                    ...
                                    <div class="col-md-4">
                                        <label class="switch">
                                            <input id="PKG_CD_PAIDOUT" name="PKG_CD_PAIDOUT" type="checkbox" value="1"
                                                class="switch-input" />
                                            <span class="switch-toggle-slider">
                                                <span class="switch-on">
                                                    <i class="bx bx-check"></i>
                                    ...
                                    <div class="col-md-4">
                                        <label class="switch">
                                            <input id="PKG_CD_GENRT_INCL" name="PKG_CD_GENRT_INCL" type="checkbox"
                                                value="1" class="switch-input" />
                                            <span class="switch-toggle-slider">
                                                <span class="switch-on">
                                                    <i class="bx bx-check"></i>
                                    ...
                                    <div class="col-md-4">
                                        <label class="switch">
                                            <input id="PKG_CD_INCL_DEPOSIT_RULE" name="PKG_CD_INCL_DEPOSIT_RULE"
                                    ...
                                    <div class="col-md-4">
                                        <label class="switch">
                                            <input id="PKG_CD_CHECK_NO_MANDATORY" name="PKG_CD_CHECK_NO_MANDATORY"
                                                type="checkbox" value="1" class="switch-input" />
                                            <span class="switch-toggle-slider">
                                                <span class="switch-on">
                                                    <i class="bx bx-check"></i>
                            ...
                            <div class="text-center statusCheck">
                                <div class="col-md-12">
                                    <label class="switch switch-lg">
                                        <input id="PKG_CD_STATUS" name="PKG_CD_STATUS" type="checkbox" value="1"
                                            class="switch-input" />
                                        <span class="switch-toggle-slider">
                                            <span class="switch-on">
                                                <i class="bx bx-check"></i>
...
function addForm() {
    ...
    $("#PKG_CD_ADJ option").prop('disabled', false); 
    ...
    $("#PKG_CD_STATUS").prop('checked', 'checked');
}
        ...
        success: function(respn) {
            $(respn).each(function(inx, data) {
                $.each(data, function(fields, datavals) {
                    ...
                    $("#PKG_CD_ADJ option[value='"+sysid+"']").prop('disabled', true); 
