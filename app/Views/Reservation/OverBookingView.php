...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="breadcrumb-wrapper py-3 mb-4"><span class="text-muted fw-light">Housekeeping /</span> Overbooking
        </h4>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="popModalWindowlable">Overbooking</h5>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" name="OB_FROM_DT" id="OB_FROM_DT" class="form-control"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" name="OB_UPTO_DT" id="OB_UPTO_DT" class="form-control"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="flxy_inlineblk">
                                    ...
                                    <div class="flxy_join">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" data-value="<?php echo $day;?>" class="switch-input"
                                                checked="checked" />
                            ...
                            <div class="col-md-12">
                                ...
                                <select name="OB_RM_CLASS" id="OB_RM_CLASS" class="select2 form-select"
                                    data-placeholder="Select Room Class" data-allow-clear="true">
                                </select>
                            </div>
                            <div class="col-md-12">
                                <lable class="form-lable">Room Type</lable>
                                <div class="mb-3">
                                    <select id="OB_RM_TYPE" name="OB_RM_TYPE" data-width="100%"
                                        class="select2 form-select OB_RM_TYPE" data-allow-clear="true">
                                        <option value="">Select</option>
                                    </select>
                                    <input type="hidden" name="OB_RM_TYPE_ID" id="OB_RM_TYPE_ID" value="" readonly />
                                </div>
                            </div>
                            <div class="col-md-12">
                                <lable class="form-lable">Overbook Count</lable>
                                <input type="number" name="OB_OVER_BK_COUNT" id="OB_OVER_BK_COUNT" class="form-control"
                                    placeholder="overbook count" />
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    return (
                        ...
                        '<li><a href="javascript:;" data_sysid="' + data['OB_ID'] +
...
$(document).on('change', '.switch-input', function() {
    ...
    if (checkedMe) {
        dayArray = jQuery.grep(dayArray, function(value) {
...
$(document).on('change', '#OB_RM_CLASS', function(e, param) {
    ...
    $.ajax({
        ...
        // async:false,
        success: function(respn) {
            $('#OB_RM_TYPE').html(respn);
        }
    });
});

//Select From Room select
$(document).on('change', '#OB_RM_TYPE', function() {

    var selectedRType = $(this).val();
    var selectedRTypeId = selectedRType != '' ? $(this).find('option:selected').attr('data-room-type-id') :
        '';
    $('#OB_RM_TYPE_ID').val(selectedRTypeId);
        ...
        success: function(respn) {
            $(respn).each(function(inx, data) {
                $.each(data, function(fields, datavals) {
                    ...
                    if (field == 'RM_TY_PSEUDO_RM' || field ==
                        ...
                        $.each(dayArr, function(i, data) {
                            ...
                            switch (data) {
                                case 'SUN':
                                    $('.switch-input:eq(0)').prop('checked',
                                        false);
                                    break;
                                case 'MON':
                                    $('.switch-input:eq(1)').prop('checked',
                                        false);
                                    break;
                                case 'TUE':
                                    $('.switch-input:eq(2)').prop('checked',
                                        false);
                                    break;
                                case 'WED':
                                    $('.switch-input:eq(3)').prop('checked',
                                        false);
                                    break;
                                case 'THU':
                                    $('.switch-input:eq(4)').prop('checked',
                                        false);
                                    break;
                                case 'FRI':
                                    $('.switch-input:eq(5)').prop('checked',
                                        false);
                                    break;
                                case 'SAT':
                                    $('.switch-input:eq(6)').prop('checked',
                                        false);
                                    break;
                                default:
