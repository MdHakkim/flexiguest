...
<div class="content-wrapper">
                        ...
                        <div class="row g-3">
                            <div class="col-4 col-sm-6 col-lg-4">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="S_GUEST_NAME" name="S_GUEST_NAME" class="form-control dt-input" data-column="0" placeholder="" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label class="col-form-label col-md-4" style="text-align: right;"><b>First
                                            Name:</b></label>
                                    <div class="col-md-8">
                                        <input type="text" id="S_CUST_FIRST_NAME" name="S_CUST_FIRST_NAME" class="form-control dt-input" data-column="0" placeholder="" />

                                    </div>
                                </div>

                                <div class="row mb-3">
                                    <label class="col-form-label col-md-4" style="text-align: right;"><b>Company:</b></label>
                                    <div class="col-md-8">
                                        <input type="text" id="S_COMPNAME" name="S_COMPNAME" class="form-control dt-input" data-column="19" placeholder="" />
                                    </div>
                                </div>
                            ...
                            <div class="col-4 col-sm-6 col-lg-4">
                                ...
                                <div class="row mb-3">
                                    <label class="col-form-label col-md-4" style="text-align: right;"><b>Arrival
                                            From:</b></label>
                                    <div class="col-md-8">
                                        <input type="text" id="S_ARRIVAL_FROM" name="S_ARRIVAL_FROM" class="form-control dt-date" placeholder="" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label class="col-form-label col-md-4" style="text-align: right;"><b>Conf
                                            No:</b></label>
                                    <div class="col-md-8">
                                        <input type="text" id="S_RESV_NO" name="S_RESV_NO" class="form-control dt-input" placeholder="" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label class="col-form-label col-md-4" style="text-align: right;"><b>Room
                                            No:</b></label>
                                    <div class="col-md-8">
                                        <input type="text" id="S_RESV_ROOM" name="S_RESV_ROOM" class="form-control dt-input" placeholder="" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-4 col-sm-6 col-lg-4">
                                ...
                                <div class="row mb-3">
                                    <label class="col-form-label col-md-4" style="text-align: right;"><b>Arrival
                                            To:</b></label>
                                    <div class="col-md-8">
                                        <input type="text" id="S_ARRIVAL_TO" name="S_ARRIVAL_TO" class="form-control dt-date" data-column="16" placeholder="" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label class="col-form-label col-md-4" style="text-align: right;"><b>Search
                                            Type:</b></label>
                                    <div class="col-md-8">
                                        <select id="S_SEARCH_TYPE" name="S_SEARCH_TYPE" class="form-select dt-select" data-column="1">
                            ...
                            <div class="col-4 col-sm-6 col-lg-4">
                                <div class="row mb-3">
                                    <label class="col-form-label col-md-4" style="text-align: right;"><b>Contact
                                            No:</b></label>
                                    <div class="col-md-8">
                                        <input type="text" id="S_GUEST_PHONE" name="S_GUEST_PHONE" class="form-control dt-input" data-column="0" placeholder="" />
                                    </div>
                                </div>

                                <div class="row mb-3">
                                    <label class="col-form-label col-md-4" style="text-align: right;"><b>Email:</b></label>
                                    <div class="col-md-8">
                                        <input type="text" id="S_CUST_EMAIL" name="S_CUST_EMAIL" class="form-control dt-input" data-column="0" placeholder="" />
                                ...
                                <div class="row mb-3">
                                    <label class="col-form-label col-md-4" style="text-align: right;"><b>Travel
                                            Agent:</b></label>
                                    <div class="col-md-8">
                                        <input type="text" id="S_AGENTNAME" name="S_AGENTNAME" class="form-control dt-input" data-column="19" placeholder="" />
                                    </div>
                                </div>
                            ...
                            <div class="col-4 col-sm-6 col-lg-4">
                                ...
                                <div class="row mb-3">
                                    <label class="col-form-label col-md-4" style="text-align: right;"><b>Departure
                                            From:</b></label>
                                    <div class="col-md-8">
                                        <input type="text" id="S_DEPARTURE_FROM" name="S_DEPARTURE_FROM" class="form-control dt-date" placeholder="" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label class="col-form-label col-md-4" style="text-align: right;"><b>Room
                                            Type:</b></label>
                                    <div class="col-md-8">
                                        <select id="S_RESV_RM_TYPE" name="S_RESV_RM_TYPE" class="select2 form-select dt-input" data-allow-clear="true">
                                            <option value=""></option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-4 col-sm-6 col-lg-4">
                                ...
                                <div class="row mb-3">
                                    <label class="col-form-label col-md-4" style="text-align: right;"><b>Departure
                                            To:</b></label>
                                    <div class="col-md-8">
                                        <input type="text" id="S_DEPARTURE_TO" name="S_DEPARTURE_TO" class="form-control dt-date" data-column="16" placeholder="" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label class="col-form-label col-md-4" style="text-align: right;"><b>Created
                                            On:</b></label>
                                    <div class="col-md-8">
                                        <input type="text" id="S_RESV_CREATE_DT" name="S_RESV_CREATE_DT" class="form-control dt-date" data-column="16" placeholder="" />
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <label class="col-form-label col-md-4" style="text-align: right;"><b>Created
                                            By:</b></label>
                                    <div class="col-md-8">
                                        <select id="S_RESV_CREATE_UID" name="S_RESV_CREATE_UID" class="select2 form-select dt-input" data-allow-clear="true">
                                            <option value=""></option>
                                            <?php
                                            if ($userList != NULL) {
                    ...
                    <div id="Accompany">
                        <div class="flxy_opt_btn text-center">
                            ...
                            <button type="button" onClick="reservExtraOption('ADO')" class="btn btn-primary">Add
                                On</button>
                            <button type="button" class="btn btn-primary show-activity-log" data-bs-toggle="modal" data-bs-target="#changesWindow">Changes</button>
                            <button type="button" class="btn btn-primary mt-2" id="registerCardButton" data_sysid="" style="width: 135px;">Registration Card</button>
                            <button type="button" class="btn btn-primary mt-2" id="fixedChargeButton" data_sysid="" style="width: 135px;">Fixed Charges</button>
                            <button type="button" class="btn btn-primary mt-2" id="proformaButton" data_sysid="" style="width: 135px;">Pro-Forma Folio</button>
    ...
    <!-- Option window -->
    <div class="modal fade" id="Addon" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div class="window-1" id="window1">
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" id="RESV_NIGHT" class="form-control RESV_NIGHT" min="0" placeholder="night" />
                                        <input type="number" id="RESV_NO_F_ROOM" class="form-control RESV_NO_F_ROOM" min="1" placeholder="no of room" />
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Adults / Children</label>
                                    <div class="input-group mb-3">
                                        <input type="number" id="RESV_ADULTS" class="form-control RESV_ADULTS" min="1" placeholder="adults" />
                                        <input type="number" id="RESV_CHILDREN" class="form-control RESV_CHILDREN" min="0" value="0" placeholder="children" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 mt-0">
                                    ...
                                    <div class="sel2Container mb-3">
                                        <select id="RESV_MEMBER_TY_ADD" class="select2 form-select" data-allow-clear="true">
                                        </select>
                                        <button type="button" onClick="checkAddMem('window-1')" class="btn flxi_btn btn-sm btn-primary text-end"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                    </div>
                                </div>
                                <div class="col-md-3 mt-0">
                                    <label class="form-label">Company</label>
                                    <div class="sel2Container mb-3">
                                        <select id="RESV_COMPANY_ADD" class="select2 form-select RESV_COMPANY" data-allow-clear="true">
                                        </select>
                                ...
                                <div class="col-md-3 mt-0">
                                    ...
                                    <div class="sel2Container mb-3">
                                        <select id="RESV_AGENT_ADD" class="select2 form-select RESV_AGENT" data-allow-clear="true">
                                        </select>
                                ...
                                <div class="col-md-3 mt-0">
                                    ...
                                    <input type="text" id="RESV_MEMBER_NO" class="form-control RESV_MEMBER_NO" placeholder="member no" readonly />
                                </div>
                                <div class="col-md-3 mt-0">
                        ...
                        <div class="window-2">
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="CUST_VIP_ADD" id="CUST_VIP_ADD" class="select2 form-select CUST_VIP" data-allow-clear="true">
                                        <option value="">Select</option>
                                    </select>
                                </div>
                                <div class="col-md-3 mt-0">
                                ...
                                <div class="col-md-3 mt-0">
                                    ...
                                    <div class="sel2Container mb-3">
                                        ...
                                        <button type="button" onClick="checkAddMem('window-2')" class="btn flxi_btn btn-sm btn-primary text-end"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                    </div>
                                </div>
                                <div class="col-md-3 mt-0">
                                    <label class="form-label">Member No</label>
                                    <input type="text" name="RESV_MEMBER_NO" id="RESV_MEMBER_NO" class="form-control" placeholder="member no" readonly />
                                    <div class="invalidfx-feedback"></div>
                                </div>
                                <div class="col-md-3 mt-0">
                                    <label class="form-label">Company</label>
                                    <div class="sel2Container mb-3">
                                        <select name="RESV_COMPANY" id="RESV_COMPANY" class="select2 form-select RESV_COMPANY" data-allow-clear="true">
                                        </select>
                                        <button type="button" onClick="companyAgentClick('COMPANY')" class="btn flxi_btn btn-sm btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                    </div>
                                </div>
                                <div class="col-md-3 mt-0">
                                    <label class="form-label">Agent</label>
                                    <div class="sel2Container mb-3">
                                        <select name="RESV_AGENT" id="RESV_AGENT" class="select2 form-select RESV_AGENT" data-allow-clear="true">
                                        </select>
                                        <button type="button" onClick="companyAgentClick('AGENT')" class="btn flxi_btn btn-sm btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-pane fade show active" id="reservationDetail">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <label class="form-label">Nights / No of Rooms</label>
                                                <div class="input-group mb-3">
                                                    <input type="number" name="RESV_NIGHT" id="RESV_NIGHT" class="form-control RESV_NIGHT" placeholder="night" min="0" required />
                                                    <input type="number" name="RESV_NO_F_ROOM" id="RESV_NO_F_ROOM" class="form-control" placeholder="no of room" min="1" required />
                                                </div>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group mb-3 flxy_fxcolm">
                                                    <div class="flxy_join">
                                                        <input type="number" name="RESV_ADULTS" id="RESV_ADULTS" class="form-control" placeholder="adults" min="1" required />
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select name="RESV_RM_TYPE" id="RESV_RM_TYPE" data-width="100%" class="select2 form-select RESV_RM_TYPE" data-allow-clear="true">
                                                    <option value="">Select</option>
                                                </select>
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="number" step="0.01" name="RESV_RATE" id="RESV_RATE" class="form-control" placeholder="rate" min="0" required />
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" readonly name="RESV_PACKAGE" id="RESV_PACKAGE" class="form-control" placeholder="Packages" required />
                                                    <button type="button" onClick="getPackages()" class="btn flxi_btn btn-sm btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                                </div>
                                                <!-- <label class="form-label">Package</label>
                                            ...
                                            <div class="col-md-3 mt-2">
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" readonly name="RESV_INV_ITEM" id="RESV_INV_ITEM" class="form-control" placeholder="Items" required />
                ...
                <div class="modal-body">
                    ...
                    <form id="customerForm" class="profileCreate">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                <label class="form-label">VIP</label>
                                <select name="CUST_VIP" id="CUST_VIP" class="select2 form-select CUST_VIP" data-allow-clear="true">
                    ...
                    <form id="rateQueryForm">
                        <div class="row g-3">
                            ...
                            <div class="col-md-2 flxy_border_over">
                                <button type="button" onClick="detailOption('OB')" class="btn btn-secondary d-grid gap-2  mx-auto"><span class="btnName">Overbooking
                                        Detail</span></button>
                                <!-- <button type="button" onClick="submitForm('customerForm','C',event)" class="btn btn-primary">Save</button> -->
                            </div>
                        </div>
                ...
                <div class="modal-footer flxy_paddng">
                    <div class="flxy_opertion flxy_opt1 border rounded">
                        ...
                        <div class="row flxy_radio">
                            <div class="col-md-12 mb-2">
                                <label class="switch">
                                    <input type="checkbox" id="closedRateFilter" class="switch-input rateFilter" value="1" />
                                    <span class="switch-toggle-slider">
                                        <span class="switch-on">
                                            <i class="bx bx-check"></i>
                                        </span>
                            ...
                            <div class="col-md-12">
                                <label class="switch">
                                    <input type="checkbox" id="dayUseRateFilter" class="switch-input rateFilter" value="1" />
                                    <span class="switch-toggle-slider">
                                        <span class="switch-on">
                                            <i class="bx bx-check"></i>
                                        </span>
                    ...
                    <div class="flxy_opertion flxy_right">
                        <div class="row">
                            ...
                            <div class="col-md-2"><button type="button" onclick="selectRate(event)" class="btn btn-primary">Ok</button></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Changes Log window -->
    <div class="modal fade" id="changesWindow" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="fixedCharges" data-backdrop="static" data-keyboard="false" aria-labelledby="popModalWindowlabel">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div id="fixedTransactionCharges" class="content">
                            ...
                            <div class="row g-3">
                                <div class="border rounded p-4 mb-3">
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            <label for="FIXD_RSV_NAME" class="col-form-label col-md-4"><b>
                                                    Name</b></label>
                                            <input type="text" name="FIXD_RSV_NAME" id="FIXD_RSV_NAME" disabled class="form-control" />

                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label for="FIXD_ARRIVAL" class="col-form-label col-md-4"><b>
                                                    Arrival</b></label>
                                            <input type="text" name="FIXD_ARRIVAL" id="FIXD_ARRIVAL" disabled class="form-control" />

                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label for="FIXD_NIGHTS" class="col-form-label col-md-4"><b>
                                                    Nights</b></label>
                                            <input type="text" name="FIXD_NIGHTS" id="FIXD_NIGHTS" class="form-control" disabled />
                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col-md-4">
                                            <label for="FIXD_CHRG_TRNCODE" class="col-form-label col-md-5"><b>TRANSACTION CODE *</b></label>
                                            <select id="FIXD_CHRG_TRNCODE" name="FIXD_CHRG_TRNCODE" class="select2 form-select form-select-lg"></select>
                                        ...
                                        <div class="col-md-4">
                                            <label for="FIXD_CHRG_QTY" class="col-form-label col-md-4"><b>QUANTITY
                                                    *</b></label>
                                            <input type="number" name="FIXD_CHRG_QTY" id="FIXD_CHRG_QTY" class="form-control" min="1" step="1" placeholder="eg: 12" />
    ...
    <div class="modal fade" id="proforma-folio" data-backdrop="static" data-keyboard="false" aria-labelledby="popModalWindowlabel">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            <div class="row g-3">
                                <div class="border rounded p-4 mb-3">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label for="FOLIO_TXT_ONE" class="col-form-label col-md-4"><b>
                                                    Folio Text1</b></label>
                                            <input type="text" name="FOLIO_TXT_ONE" id="FOLIO_TXT_ONE" class="form-control" />

                                        </div>
                                        <div class="col-md-12 mb-3">
                                            <label for="FOLIO_TXT_TWO" class="col-form-label col-md-4"><b>
                                                    Folio Text2</b></label>
                                            <input type="text" name="FOLIO_TXT_TWO" id="FOLIO_TXT_TWO" class="form-control" />
                                    ...
                                    <div class="row g-3 ">
                                        <div class="form-check mt-3 p-0">
                                            <label class="switch">
                                                <input type="checkbox" class="switch-input" checked id="PRINT_PHONE" name="PRINT_PHONE" method="PM" />
                                                <span class="switch-toggle-slider">
                                                    <span class="switch-on">
                                                        <i class="bx bx-check"></i>
                                                    </span>
                                        ...
                                        <div class="form-check mt-3 p-0">
                                            <label class="switch">
                                                <input type="checkbox" class="switch-input " checked id="PRINT_CHECK" method="PM" name="PRINT_CHECK" />
                                                <span class="switch-toggle-slider">
                                                    <span class="switch-on">
                                                        <i class="bx bx-check"></i>
                                                    </span>
                                        ...
                                        <div class="form-check mt-3 p-0 mb-3">
                                            <label class="switch">
                                                <input type="checkbox" class="switch-input " checked id="PRINT_EMAIL" method="PM" name="PRINT_EMAIL" />
                                                <span class="switch-toggle-slider">
                                                    <span class="switch-on">
                                                        <i class="bx bx-check"></i>
                                                    </span>
    ...
    <div class="modal fade" id="packagesModal" data-backdrop="static" data-keyboard="false" aria-labelledby="popModalWindowlabel">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                        ...
                        <div id="packages" class="content">                            
                            <div class="row g-3">
                                <div class="border rounded p-4 mb-3">
                                    <div class="row g-3 mb-3">
                                        <div class="col-md-4 ">
                                            <label for="PCKG_ID" class="col-form-label col-md-4"><b>Package
                                                    *</b></label>
                                            <select id="PCKG_ID" name="PCKG_ID" class="select2 form-select form-select-lg">
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="number" name="RSV_PCKG_QTY" id="RSV_PCKG_QTY" class="form-control" min="1" max="99" placeholder="eg: 10" />
                                        </div>

                                        <div class="col-md-2 ">
                                            <label for="PACKAGE_EXCLUDE" class="col-form-label col-md-4"><b>Exclude
                                                </b></label>
                                            <input type="text" name="PACKAGE_EXCLUDE" id="PACKAGE_EXCLUDE" class="form-control" readonly />

                                        </div>

                                        <div class="col-md-4">
                                            <label for="RSV_PCKG_POST_RYTHM" class="col-form-label col-md-4"><b>POSTING RHYTHM</b></label>
                                            <input type="text" name="RSV_PCKG_POST_RYTHM" id="RSV_PCKG_POST_RYTHM" readonly class="form-control" />
                                    ...
                                    <div class="row g-3 ">
                                        <div class="col-md-4">
                                            <label for="RSV_PCKG_CALC_RULE" class="col-form-label"><b>CALCULATION RULE</b></label>
                                            <input type="text" name="RSV_PCKG_CALC_RULE" id="RSV_PCKG_CALC_RULE" class="form-control" readonly/>

                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label for="RSV_PCKG_BEGIN_DATE" class="col-form-label col-md-4"><b>Start
                                                    Date </b></label>
                                            <input class="form-control" type="text" placeholder="yyyy-mm-d" id="RSV_PCKG_BEGIN_DATE" name="RSV_PCKG_BEGIN_DATE" />
                                        </div>
                                        <div class="col-md-4 END_DATE">
                                            <label for="RSV_PCKG_END_DATE" class="col-form-label col-md-4"><b>End
                                                    Date </b></label>
                                            <input class="form-control" type="text" placeholder="yyyy-mm-d" id="RSV_PCKG_END_DATE" name="RSV_PCKG_END_DATE" />
                                        </div>
                                    </div>
