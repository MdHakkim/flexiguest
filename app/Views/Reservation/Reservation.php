                            ...
                            <div class="col-4 col-sm-6 col-lg-4">
                                ...
                                <div class="row mb-3">
                                    <label class="col-form-label col-md-4" style="text-align: right;"><b>First
                                            Name:</b></label>
                                    <div class="col-md-8">
                                        <input type="text" id="S_GUEST_FIRST_NAME" name="S_GUEST_FIRST_NAME" class="form-control dt-input" data-column="0" placeholder="" />
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" id="RESV_CHILDREN" class="form-control RESV_CHILDREN" min="0" placeholder="children" />
                                    </div>
                                </div>
                                ...
                                <div class="border rounded p-4 mb-3" >
                                    <div class="row">
                                        <div class="col-md-3 mb-3">
                                            <label for="FIXD_RSV_NAME" class="col-form-label col-md-4"><b> Name</b></label>
                                            <input type="text" name="FIXD_RSV_NAME" id="FIXD_RSV_NAME" disabled class="form-control" />

                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label for="FIXD_ARRIVAL" class="col-form-label col-md-4"><b> Arrival</b></label>
                                            <input type="text" name="FIXD_ARRIVAL" id="FIXD_ARRIVAL"  disabled class="form-control" />

                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label for="FIXD_NIGHTS" class="col-form-label col-md-4"><b> Nights</b></label>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-2 mb-3">
                                            <label for="FIXD_CHRG_FREQUENCY" class="col-form-label col-md-4"><b> FREQUENCY</b></label>
