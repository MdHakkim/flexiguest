        ...
        <tr>
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                            <tr>
                                                                <td align="center">
                                                                    <a href="<?= $reset_url ?>" class="f-fallback button button--green" target="_blank">Reset your password</a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                            ...
                                            <p>If you did not request a password reset, please ignore this email or <a href="<?= base_url() ?>">contact support</a> if you have questions.</p>
                                            <p>Thanks,
                                                <br>The FlexiGuest team
                                            </p>
                                            <!-- Sub copy -->
