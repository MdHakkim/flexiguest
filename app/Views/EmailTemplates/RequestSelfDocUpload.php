                                    ...
                                    <td style="font-size:16px;">
                                      <table border="0"  cellspacing="0" cellpadding="0" >
                                        ...
                                        <tr style="padding-bottom:6px;">
                                          ...
                                          <td>
                                            <div style="background: black;padding: 10px;text-align: center;width: 160px;color: white;border-radius: 7px;position: relative;top: -3px;"><a style="color: white;text-decoration: none;" href="https://flexiguest.hitekservices.com/webline/ReservationDetail/<?= $data['RESV_ID'] ?>">Click Pre Check-In</a></div>
                                          </td>
                                        </tr>
                                        </tbody>
                                      </table>
