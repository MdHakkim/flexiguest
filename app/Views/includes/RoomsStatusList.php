    ...
    <div class="row g-3 mb-2">
        <div class="col-12 col-sm-4 col-lg-4 d-none arriv_date_div">
            <div class="row border rounded p-3 pb-4 m-1">
                <h6 class="mb-4">Reservation Period</h6>
                <div class="row mb-3">
                    <label
                        class="col-form-label col-md-5 col-lg-5 d-flex justify-content-lg-end justify-content-sm-start"><b>Date:</b></label>
                    <div class="col-md-7 col-lg-7">
                        ...
                        <div class="d-none">
                            <input type="text" id="S_ARRIVAL_DATE" name="S_ARRIVAL_DATE" class="form-control"
                ...
                <div class="row mb-1">
                    <label
                        class="col-form-label col-md-5 col-lg-5 d-flex justify-content-lg-end justify-content-sm-start"><b>Nights:</b></label>
                    <div class="col-md-4 col-lg-4">
                        ...
                        <div class="d-none">
                            <input type="text" id="S_NIGHTS" name="S_NIGHTS" class="form-control" placeholder=""
                                readonly />
                        </div>
                    </div>
                </div>
                <input type="hidden" name="S_RESV_ID" id="S_RESV_ID" value="" readonly />
            </div>
        </div>
        ...
        <div class="col-12 col-sm-8 col-lg-4">
            <div class="row border rounded p-3 pb-4 m-1">
                ...
                <div class="col-md pe-1">
                    ...
                    <div class="d-none">
                        <div class="switches-stacked active_rm_stat_div">
                    ...
                    <div class="d-none">
                        <div class="switches-stacked">
                            ...
                            <label class="switch switch-<?= $room_status['RM_STATUS_COLOR_CLASS'] ?>">
                                <input type="checkbox" class="switch-input S_RM_STATUS_ID" name="S_RM_STATUS_ID[]"
        ...
        <div class="col-12 col-sm-4 col-lg-2">
            <div class="row border rounded p-3 pb-4 ps-2 m-1 fo_stat_search_div">
                ...
                <div class="col-md">
                    ...
                    <div class="d-none">
                        <div class="switches-stacked">
                            <label class="switch d-none check_out_chk">
                                <input type="checkbox" class="switch-input S_RESV_STATUS" name="S_RESV_STATUS[]"
                                    value="Due Out">
                                <span class="switch-toggle-slider">
                                    <span class="switch-on"></span>
                                    <span class="switch-off"></span>
                            ...
                            <label class="switch">
                                <input type="checkbox" id="S_FO_STATUS_VAC" class="switch-input S_FO_STATUS"
                            ...
                            <label class="switch occ_chk">
                                <input type="checkbox" class="switch-input S_FO_STATUS" name="S_FO_STATUS[]"
                                    value="OCC">
                                <span class="switch-toggle-slider">
                                    <span class="switch-on"></span>
                                    <span class="switch-off"></span>
                            ...
                            <label class="switch occ_chk"></label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 col-sm-8 col-lg-4 resv_stat_search_div">
            <div class="row border rounded p-3 pb-4 m-1">
                ...
                <div class="col-md">
                    ...
                    <div class="d-none">
                        <div class="switches-stacked">
                            ...
                            <label class="switch">
                                <input type="checkbox" id="S_RESV_STATUS_NR" class="switch-input S_RESV_STATUS"
        ...
        <div class="col-12 col-sm-4 col-lg-2 service_stat_search_div">
            <div class="row border rounded p-3 pb-4 ps-2 m-1">
                ...
                <div class="col-md">
                    ...
                    <div class="d-none">
                        <div class="switches-stacked">
                            <label class="switch">
                                <input type="checkbox" class="switch-input S_SRV_STATUS" name="S_SRV_STATUS[]"
                                    value="1">
                                <span class="switch-toggle-slider">
                                    <span class="switch-on"></span>
                                    <span class="switch-off"></span>
            ...
            <div class="row border rounded p-3 pb-1 m-1">
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="d-none">
                                <select id="S_RM_CLASS" name="S_RM_CLASS" class="select2 form-select dt-input"
                ...
                <div class="col-12 col-sm-6 col-lg-8">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9 roomTypeSelDiv">
                            ...
                            <div class="d-none">
                                <select name="S_RM_FEATURES[]" id="S_RM_FEATURES" data-width="100%" multiple
                                    class="select2 form-select" data-placeholder="Any Room Feature"
                                    data-allow-clear="true">
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="d-none S_RM_ID_div col-12">
                                <select id="S_RM_ID" name="S_RM_ID[]" class="selectpicker w-100"
                                    ...
                                    data-placeholder="Enter 3 or more characters" data-allow-clear="true">
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-6 col-lg-5">
                    ...
                    <div class="mb-3 d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-success use_selected_rooms" data-change-selected="0"><i
...
$(document).ready(function() {
    ...
    if ($('#assignRoomSearch').length) {
        $('.use_selected_rooms').addClass('d-none');
        $('.assign_selected_room').removeClass('d-none');
    }
    ...
    $(document).on('click', '#room_list > tbody > tr', function() {
        ...
        if (clicked_room_ids.length == 0) {
            if ($('#assignRoomSearch').length) {
                toggleButton('.assign_selected_room', 'btn-success', 'btn-dark', true);
            ...
            if ($('#assignRoomSearch').length) {
                toggleButton('.assign_selected_room', 'btn-dark', 'btn-success', false);
                $('.assign_selected_room').attr({
        ...
        if ($('#assignRoomSearch').length) {
            ...
            $('#room_list > tbody > tr').not(this).removeClass('table-warning');
        }
...
function loadRoomsTable(filterData) {

    var selectOpts = $('#assignRoomSearch').length ? {
        style: 'single',
        info: false
    } : {
        style: 'multi',
    ...
    $('#room_list').DataTable({
        ...
        'ajax': {
            ...
            'data': function(d) {
                ...
                if (filterData.length) {
                    $.each(filterData, function(i, filterDetail) {
                        if ($(filterDetail['field']).length) {
                            if (filterDetail['class'] !== undefined && $(filterDetail['field']) // Selectpicker
                                .hasClass(filterDetail['class'])) {
                                if (filterDetail['class'] == 'selectpicker' && filterDetail[
                                        'htmlOption'] !== undefined) {
                                    $(filterDetail['field']).html(filterDetail['htmlOption'])
                                        .selectpicker('refresh');
                                    $(filterDetail['field']).val(filterDetail['value'])
                                        .selectpicker('refresh');
                                }
                            } else if (filterDetail['checked'] !== undefined) { // Checkbox
                                $(filterDetail['field']).prop("checked", filterDetail['checked'] ==
                                    1 ?
                                    true : false);
                            } else
                                $(filterDetail['field']).val(filterDetail['value']);
                ...
                var formSerialization = $('.dt_adv_rm_search').serializeArray();
                $(formSerialization).each(function(i, field) {
                    if (field.name == 'S_RM_TYPES[]') {
                        ...
                        selectedRoomTypes.each(function(i, item) {
                            room_types.push(item.getAttribute(
                                'data-room-type-id'));
                        });
        ...
        'columns': [{
            ...
            },
            {
                ...
                "visible": $('#assignRoomSearch').length ? false : true
            },
            {
                data: 'RESV_STATUS',
                className: "text-center"
        ...
        columnDefs: [{
            ...
            render: function(data, type, full, meta) {
                ...
                return full['FO_STATUS'] == 'OCC' ? showServiceStatChange($serv_stat,
                    full[
                        'RM_ID']) : '';
            }
        }, {
        ...
        language: {
            emptyTable: $('#assignRoomSearch').length ? 'There are no unassigned rooms to display' :
                    ...
                    var data = $.map(columns, function(col, i) {
                        ...
                        var dataVal = col.title == 'Features' ?
                            ...
                            (col.title == 'Reservation Status' ? (col.data ==
                                ...
                                (col.title == 'Room Status' ? showRoomCurrentStat(
                                        room_id) :
...
function showRoomStatChange(curStatId, curStatName, rmId) {
    ...
    var $statButton = '<button type="button" class="btn btn-sm ' + $status[
            $status_id]
        .class + (!$('#assignRoomSearch').length ? ' dropdown-toggle"' : ' "') +
        (!$('#assignRoomSearch').length ? 'data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">' :
            '>') +
        $status_name + '</button>';

    if ($status_id != '4' && $status_id != '5' && !$('#assignRoomSearch').length) {
...
function showServiceStatChange(curStatId, rmId) {
    ...
    var $statButton = '<button type="button" class="btn btn-sm ' + $serv_status[$serv_status_id].class +
        ' dropdown-toggle"' +
        'data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">' + $serv_status_name +
        '</button>';
...
$(document).on('click', '.use_selected_rooms', function() {
    ...
    $('#selectRoomsFrom,#selectRoomsTo').prop('disabled', hasSelectedRooms == '1' ? true : false)
        .selectpicker(
            'refresh');
    ...
    if (clicked_room_ids.length > 0) {
        ...
        $.ajax({
            ...
            $.each(clicked_room_ids, function(i, room_id) {
                $("#selectRoomsList option[data-room-id='" + room_id + "']").prop(
                    "selected",
                    true);
            });
...
function setRmAssignSearchDefault() {
    return [{
        ...
        {
            field: '#S_FO_STATUS_VAC',
            value: 'VAC',
            status: '0',
            checked: '1'
        },
        {
            field: '#S_RESV_STATUS_NR',
            value: 'Not Reserved',
            status: '1',
            checked: '1'
        }
...
function resetRoomSelectButton(type) {
...
$(document).on('click', '#quickChangeSubmitBtn', function() {
    ...
    if (selectRoomsBy == 'L') {
        ...
        var selectRoomsFrom = $('#selectRoomsFrom').val() ? $('#selectRoomsFrom').find('option:selected')
            .attr(
                'data-room-id') : null;
...
(function() {
    ...
    $(document).on('click', '.submitAdvSearch', function() { // Click Search button
        ...
        $('#assignRoomSearch').length ? resetRoomSelectButton('single') : resetRoomSelectButton('multi');

        //dt_adv_filter_table.dataTable().fnDraw();
        var filterData = $('#assignRoomSearch').length ? setRmAssignSearchDefault() : [];
