        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="flxy_opt_btn text-center">
                    <button type="button" class="btn btn-primary show-cust-activity-log" data_sysid="" data-bs-toggle="modal"
                        data-bs-target="#customerChangesWindow">Changes</button>
...
<div class="modal fade" id="customerChangesWindow" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="customerChangesWindowLabel">Activity Log</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-lable="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
...
$(document).on('click', '.custOptions', function() {
    ...
    $('#custOptionsWindow').find('.data-port,.delete-record,.show-cust-activity-log').attr('data_sysid', custOptId);
});
