...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="breadcrumb-wrapper py-3 mb-4"><span class="text-muted fw-light">Masters /</span> Departments</h4>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="popModalWindowlabel">Department</h4>
                ...
                <div class="modal-body">
                    <form id="submitForm" class="needs-validation" novalidate>
                        <div class="row g-3">
                            ...
                            <div class="col-md-7">
                                <lable class="form-lable"><b>Department Code *</b></lable>
                                <input type="text" name="DEPT_CODE" id="DEPT_CODE" class="form-control bootstrap-maxlength"
                                    maxlength="10" placeholder="eg: ICT" required />
                            </div>
                            <div class="col-md-8">
                                <lable class="form-lable"><b>Description *</b></lable>
                                <input type="text" name="DEPT_DESC" id="DEPT_DESC" class="form-control bootstrap-maxlength"
                                    maxlength="50" placeholder="eg: Information Comm." required />
                            </div>
                            <div class="col-md-4">
                                <lable class="form-lable"><b>Seq No:</b></lable>
                                <input type="number" name="DEPT_DIS_SEQ" id="DEPT_DIS_SEQ" class="form-control" min="1"
                                    placeholder="eg: 2" />
                            </div>

                            <div class="col-md-6">
                                <label class="switch">
                                    <input id="DEPT_STATUS"  value="1" name="DEPT_STATUS" type="checkbox"
                                        class="switch-input" />
...
$(document).ready(function() {
    ...
    $('#dataTable_view').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url': '<?php echo base_url('/DepartmentView')?>'
        },
        'columns': [{
                data: ''
            },
            ...
            
            {
                ...
                render: function(data, type, row, meta) {
                    return (
                        ...
                        '<li><a href="javascript:;" data_sysid="' + data['DEPT_ID'] +
        ...
        }, 
        {
          ...
          width: "15%",
          render: function (data, type, full, meta) {
            var $status_number = full['DEPT_STATUS'];
            var $status = {
...
function addForm() {
    ...
    $('#popModalWindowlabel').html('Add New Department');
...
function submitForm(id) {
    ...
    var url = '<?php echo base_url('/insertDepartment')?>';
    $.ajax({
        url: url,
        type: "post",
        ...
        success: function(respn) {
            ...
            if (response != '1') {
                ...
                var alertText = $('#DEPT_ID').val() == '' ? '<li>The new Department \'' + $(
                        '#DEPT_CODE')
                    .val() + '\' has been created</li>' : '<li>The Department \'' + $(
                        '#DEPT_CODE').val() +
                    '\' has been updated</li>';
