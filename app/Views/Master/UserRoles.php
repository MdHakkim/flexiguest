                        ...
                        <tr>
                            ...
                            <div class="d-flex">
                                ...
                                <label class="switch switch-lg">
                                        <input id="selectAll" name="MENU_ID[]" id="MENU_ID0" type="checkbox" value="0"
                                            class="switch-input" />
                  ...
                  <?php if(!empty($responseMenu)) {   
                        ...
                        <tr>
                            ...
                            <div class="d-flex">
                                <div class="form-check me-3 me-lg-5">
                                <label class="switch switch-lg">
                                        <input id="MENU_ID<?php echo $row['MENU_ID']?>" name="MENU_ID[]" type="checkbox" value="<?php echo $row['MENU_ID']?>"
                                            class="switch-input" />
                                        <span class="switch-toggle-slider">
                                            <span class="switch-on">
                                                <i class="bx bx-check"></i>
