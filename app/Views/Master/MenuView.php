...
<div class="content-wrapper">
                ...
                <div class="modal-body">
                    <form id="submitForm" class="needs-validation" novalidate>
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label"><b>Menu Code *</b></label>
                                <input type="text" name="MENU_CODE" id="MENU_CODE"
                                    class="form-control bootstrap-maxlength" maxlength="10" placeholder="eg: RESV"
                                    required />
                            </div>
                            <div class="col-md-6">
                                <label class="form-label"><b>Menu Name *</b></label>
    ...
    <div class="modal fade" id="copyModalWindow" data-backdrop="static" data-keyboard="false"
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="copyModalWindowlabel">Create menu copies</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-lable="Close"></button>
                </div>
                <div class="modal-body">
                    ...
                    <form id="copyForm" class="form-repeater needs-validation" novalidate>
                            ...
                            <div data-repeater-item>
                                <div class="row">
                                    <div class="col-12 col-md-8 mb-0 mb-3">
                                        <label class="form-label" for="form-repeater-1-1"><b>Menu Code
                                                *</b></label>
                                        <input type="text" name="MENU_CODE" id="form-repeater-1-1" class="form-control"
                                            maxlength="10" placeholder="eg: RESV" required />
                                    </div>
                        ...
                        <div style="float: right;">
                            <input type="hidden" name="main_Menu_ID" id="main_Menu_ID" class="form-control" />
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button type="button" id="copyBtn" onClick="copyForm('copyForm')"
                                class="btn btn-primary">Save</button>
                        </div>
                    </form>
                    <div class="form-text" style="clear: both; padding-top: 20px;">Menu Description will
...
$(document).on('click', '.copyWindow', function() {
    ...
    var sysid = $(this).attr('data_sysid');
    var rolecode = $(this).attr('data_menucode');

    $('#main_Menu_ID').val(sysid);

    $('#copyModalWindowlabel').html('Create menu copies of \'' + rolecode + '\'');
...
// Add New or Edit Menu submit Function
...
// Copy Menu to Multiple submit Function

function copyForm(id) {
    hideModalAlerts();

    var formSerialization = $('#' + id).serializeArray();
    var url = '<?php echo base_url('/copyMenu')?>';
    $.ajax({
        url: url,
        type: "post",
        data: formSerialization,
        ...
        success: function(response) {
            if (response == '0') {
                showModalAlert('error', '<li>No new menu is added</li>');
            } else {
                showModalAlert('success', '<li>' + response +
                    ' new menu copy has been created</li>');
