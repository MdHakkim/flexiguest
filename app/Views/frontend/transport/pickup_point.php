...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="breadcrumb-wrapper py-3 mb-4"><span class="text-muted fw-light">Masters /</span> Pickup Points</h4>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title" id="popModalWindowlabel">Pickup Point</h4>
                    ...
                    <form id="submit-form" class="needs-validation" novalidate>
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="PP_POINT" class="form-control" placeholder="Point" required />
                            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#dataTable_view').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': '<?php echo base_url('transport/pickup-point/all-pickup-points') ?>'
            },
            'columns': [{
                    data: ''
                },
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        <div class="d-inline-block">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a href="javascript:;" data_id="${data['PP_ID']}" class="dropdown-item editWindow text-primary">
                                ...
                                <li>
                                    <a href="javascript:;" data_id="${data['PP_ID']}" class="dropdown-item text-danger delete-record">
            ...
            responsive: {
                details: {
                    display: $.fn.dataTable.Responsive.display.modal({
                        header: function(row) {
                            var data = row.data();
                            return 'Details of ' + data['PP_POINT'];
                        }
                    }),
                    type: 'column',
    ...
    function submitForm() {
        ...
        $.ajax({
            url: '<?= base_url('transport/pickup-point/store') ?>',
            type: "post",
            data: fd,
            processData: false,
            contentType: false,
    ...
    $(document).on('click', '.editWindow', function() {
        ...
        let pickup_point_id = $(this).attr('data_id');
        $('.dtr-bs-modal').modal('hide');

        let id = "submit-form";
        $(`#${id} input[name='id']`).val(pickup_point_id);

        $('#popModalWindowlabel').html('Edit Pickup Point');
        $('#popModalWindow').modal('show');

        var url = '<?php echo base_url('transport/pickup-point/edit') ?>';
        $.ajax({
            url: url,
            type: "post",
            data: {
    ...
    $(document).on('click', '.delete-record', function() {
        ...
        bootbox.confirm({
            ...
            callback: function(result) {
                if (result) {
                    $.ajax({
                        url: '<?php echo base_url('transport/pickup-point/delete') ?>',
                        type: "post",
                        data: {
                            id: id,
                            '_method': 'delete'
