...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="breadcrumb-wrapper py-3 mb-4"><span class="text-muted fw-light">Masters /</span> Property Info</h4>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title" id="popModalWindowlabel">Property Info</h4>
                    ...
                    <form id="submit-form" class="needs-validation" novalidate>
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="file" name="PI_FILE" class="form-control" accept="application/pdf" />
                            </div>
                        </div>
                    </form>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#dataTable_view').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': '<?php echo base_url('/property-info/all-property-info') ?>'
            },
            'columns': [{
                    data: ''
                },
                {
                    ...
                    render: function(data) {
                        return `<a href="${data['PI_URL']}" target="_blank">
                                    ${data['PI_NAME']}
                                </a>`;
                    }
                },
        ...
        $("#dataTable_view_wrapper .row:first").before(
            '<div class="row flxi_pad_view"><div class="col-md-3 ps-0"><button type="button" class="btn btn-primary" onClick="addForm()"><i class="fa-solid fa-plus fa-lg"></i> Update</button></div></div>'
        );
    });
    ...
    function addForm() {
        ...
        $('#popModalWindowlabel').html('Update Property Info');
    ...
    function submitForm() {
        ...
        let files = $(`#${id} input[name='PI_FILE']`)[0].files;
        if (files.length)
            fd.append('PI_FILE', files[0]);

        $.ajax({
            url: '<?= base_url('property-info/store') ?>',
            type: "post",
            data: fd,
            processData: false,
            contentType: false,
