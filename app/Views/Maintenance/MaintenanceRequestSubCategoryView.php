        ...
        $.ajax({
            ...
            success: function(respn) {
                ...
                $(respn).each(function(ind, data) {
                    data['MAINT_CATEGORY_TYPE'] = data['MAINT_CATEGORY_TYPE'].replace('_', ' ').toUpperCase();
                    option += '<option value="' + data['MAINT_CAT_ID'] + '">' + data['MAINT_CATEGORY'] + ' - ' + data['MAINT_CATEGORY_TYPE'] + '</option>';
                });
